				...
				<div class="card-body">
					...
					<form class="woocommerce-form woocommerce-form-login login" method="post">
	                	...
	                	<div class="text-right">
							<button type="submit" class="woocommerce-button button woocommerce-form-login__submit btn rounded-0 btn-dark<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Log in', 'bookworm' ); ?>"><i class="<?php echo esc_attr( apply_filters( 'front_login_form_button_icon', 'bwi-sign-in' ) ); ?> mr-2 ml-n21"></i><?php esc_html_e( 'Log in', 'bookworm' ); ?></button>
						</div>
		...
		<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
			<div class="col-md-6 pt-4 mt-3 mt-md-0">
				...
				<form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
	            	...
	            	<div class="text-right">
						<button type="submit" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn rounded-0 btn-dark<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="register" value="<?php esc_attr_e( 'Register', 'bookworm' ); ?>"><i class="<?php echo esc_attr( apply_filters( 'front_registration_form_button_icon', 'bwi-user' ) ); ?> mr-2 ml-n1"></i><?php esc_html_e( 'Register', 'bookworm' ); ?></button>
