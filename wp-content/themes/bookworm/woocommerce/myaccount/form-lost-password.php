			...
			<form method="post" class="woocommerce-ResetPassword lost_reset_password">
				...
				<div class="card py-2 mt-4">
					<div class="card-body">
						...
						<button type="submit" class="woocommerce-Button button btn btn-dark rounded-0<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Reset password', 'bookworm' ); ?>"><?php esc_html_e( 'Reset password', 'bookworm' ); ?></button>
