...
<form class="woocommerce-form woocommerce-form-login login p-4 p-md-6" method="post">
    ...
    <div class="mb-4d75">
        ...
        <button type="submit" class="woocommerce-form-login__submit btn btn-block py-3 rounded-0 btn-dark<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" name="login" value="<?php esc_attr_e( 'Sign In', 'bookworm' ); ?>"><?php esc_html_e( 'Sign In', 'bookworm' ); ?></button>
    </div>
