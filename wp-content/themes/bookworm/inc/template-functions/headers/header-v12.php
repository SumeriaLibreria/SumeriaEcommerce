...
if ( ! function_exists( 'bookworm_site_header_v12_offcanvas_toggle_links' ) ) {
    ...
    function bookworm_site_header_v12_offcanvas_toggle_links() {
        bookworm_site_header_offcanvas_toggle_links( 'text-dark', 'text-white bg-dark', 'font-size-5 text-dark', 'text-secondary-gray-1090 font-size-1', 'ml-auto header-icons-links' );
    }
}
