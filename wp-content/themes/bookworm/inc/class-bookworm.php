...
if ( ! class_exists( 'Bookworm' ) ) :
	...
	class Bookworm {
		...
		/**
		 * Get the sidebar arguments for blog sidebar.
		 *
		 * @return array
		 */
		 ...
		 * @param array $params Blog Sidebar params.
		 */
		...
		public function scripts() {
			 ...
			 * Fonts.
			 */
			wp_enqueue_style( 'bookworm-fonts', $this->google_fonts(), array(), $bookworm_version );
			...
			$bookworm_options = apply_filters(
				'bookworm_localize_script_data',
				array(
					'rtl'                      => is_rtl() ? '1' : '0',
